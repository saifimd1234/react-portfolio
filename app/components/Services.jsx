...
const Services = () => {
  return (
    <div id="services" className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <p>I am a frontend developer from Delhi, India with 3 years of experience in multiple projects including ML, frontend, data analysis and data engineering.</p>
